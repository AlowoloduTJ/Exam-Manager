...
export function AnimatedGradientText({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 block h-full w-full animate-gradient rounded-2xl bg-gradient-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:300%_100%] opacity-50"
        style={{
          clipPath: "inset(1px)",
        }}
      />
